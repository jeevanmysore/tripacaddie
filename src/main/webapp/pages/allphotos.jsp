...
<script type="text/javascript">
	...
	function getVideos(){
		window.location.href="/tripcaddie/trip/allVideos.do";
	}
	...
	function sortPhotos(order){
		window.location.href="/tripcaddie/trip/AllpicturesbySort.do?sortorder="+order;
	}
</script>
</head>
<body>
	...
	<h3>Photo and Video Gallery - All Trips</h3> <input type="button" value="Back" onclick="back();" />
	...
	<p>Sort By:<a href="#" onclick="sortPhotos('date');">Date</a>|<a href="#" onclick="sortPhotos('rating');">Rating</a>|<a href="#" onclick="sortPhotos('favourites');">My Favorites</a></p>
	<div id="trips">
