...
<script type="text/javascript">
	...
	function sortVideos(order){
		window.location.href="/tripcaddie/trip/AllvideosbySort.do?sortorder="+order;
	}
</script>
</head>
<body>
	...
	<p>Sort By:<a href="#" onclick="sortVideos('date');">Date</a>|<a href="#" onclick="sortVideos('rating');">Rating</a>|<a href="#" onclick="sortVideos('favourites');">My Favorites</a></p>
	<div id="trips">
